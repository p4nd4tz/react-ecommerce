...
export default function ProductList() {
    ...
    useEffect(() => {
        ...
        dispatch(fetchProductByFilterAsync({ filter, pagination }));
                        ...
                        <div key={product.id}>
                            <Link to={`/products/${product.id}`} >
                                <div className="group relative">
                                    <div
                                        className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-72"
                                    >
                                        <img
                            ...
                            {
                                product.deleted && 
                                <p className="text-red-500 text-start">product is deleted</p>
                            }
